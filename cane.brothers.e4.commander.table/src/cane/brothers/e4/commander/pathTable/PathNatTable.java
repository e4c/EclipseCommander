...
public class PathNatTable extends NatTable implements IRootPath {
    ...
    private static final Logger log = LoggerFactory.getLogger(PathNatTable.class);
     ...
     * @param eventBroker
     */
    public PathNatTable(Composite parent, Path rootPath, IEventBroker eventBroker) {
        super(parent, false);
        ...
        selectionProvider = new RowSelectionProvider<PathFixture>(compositeLayer.getSelectionLayer(),

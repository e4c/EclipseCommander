package cane.brothers.nattable.test.path.style;
...
public class PathFirstThemeConfiguration extends
		DefaultNatTableThemeConfiguration {
	{
		...
		this.cHeaderCellPainter = new PaddingDecorator(new TextPainter(), 0, 5, 5, 5);
...
//				new PaddingDecorator(new TextPainter(false, false), 0, 5, 5, 5, false));
